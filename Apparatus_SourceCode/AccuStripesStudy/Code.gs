...
const attributeNamesColorOnly = [ 
  ...
  "Q11", "Q11_Confident", "Q11_Time",
  "Q12", "Q12_Confident", "Q12_Time",
  "Q13", "Q13_Confident", "Q13_Time",
  "Q14", "Q14_Confident", "Q14_Time",
  "Q15", "Q15_Confident", "Q15_Time",
...
const ssIds = ["XXX", //Results_ColorOnly
               "XXX", //Results_Overlay
               "XXX", //Results_FilledCurve
               "XXX"  //"Results_LineChart"
              ]
...
const numberOfQuestions = 15; //main questions in html
...
function createQuestionHTML()
{
  ...
  var questionaireID = (1).toFixed(0);
  ...
  if(questionaireID == 0)
  { 
    template = HtmlService.createHtmlOutputFromFile('Questions_ColorOnly').getContent();
  }
  else if(questionaireID == 1)
  {
    template = HtmlService.createHtmlOutputFromFile('Questions_Overlay').getContent();
  }
  else if(questionaireID == 2)
  {
    template = HtmlService.createHtmlOutputFromFile('Questions_FilledCurve').getContent();
  }
  else if(questionaireID == 3)
  {
    template = HtmlService.createHtmlOutputFromFile('Questions_LineCharts').getContent();
  }
